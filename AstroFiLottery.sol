...
contract AstroFiLottery is ReentrancyGuard, IAstroFiLottery, Ownable {
    ...
    function drawFinalNumberAndMakeLotteryClaimable(
        ...
        uint256 amountToShareToWinners = (
            ((_lotteries[_lotteryId].amountCollectedInAfi) *
        ...
        amountToWithdrawToTreasury += (_lotteries[_lotteryId]
            .amountCollectedInAfi - amountToShareToWinners);
    ...
    function startLottery(
        ...
        require(
            (_priceTicketInAfi >= minPriceTicketInAfi) &&
                (_priceTicketInAfi <= maxPriceTicketInAfi),
            "Outside of limits"
        );
     ...
     */
    function setMinAndMaxTicketPriceInAfi(
        uint256 _minPriceTicketInAfi,
        uint256 _maxPriceTicketInAfi
    ) external onlyOwner {
        require(
            _minPriceTicketInAfi <= _maxPriceTicketInAfi,
